...
const nodes = [
  ...
  {
    id: "MedicationKnowledge/40",
    size: 120,
    productType: "pharmprod",
    label: "Diclofenac 50 mg Solução Oral\nRoute: Oral\n productType: Pharmaceutical Product\nDoseFrom: Comprimido Revestido",
    color: "#FFCFCF",
    shape: "box",
  ...
  {
    id: "MedicationKnowledge/39",
    size: 150,
    label: "ProductTye: medproduct\nstatus: active\nsynonym: outro 50 mg Comprimido revestido\n productType: MEDPROD\n productType_0_coding_0_system: http://terminology.hl7.org/CodeSystem/medicineCS\n amount: 50\n amount_unit: mg\n doseForm: 38.0\n doseForm_coding_0_system: http://infarmed.pt/pharm_Form\n doseForm_coding_0_display: Comprimido revestido\n ",
    color: "#DAF7A6",
    shape: "box",
    doseForm: "Solução Oral",
    route: "Oral",
